...
public class AdminVoucher extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEditTextFileName = findViewById(R.id.edit_text_file);
        mImageView = findViewById(R.id.image_view);
        mProgressBar = findViewById(R.id.progress_bar);

        mStorageRef = FirebaseStorage.getInstance().getReference("vouchers");
        ...
        mButtonUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(mUploadTask != null && mUploadTask.isInProgress()){
                    Toast.makeText(AdminVoucher.this,"Upload in progress", Toast.LENGTH_SHORT).show();
                }
                else{
                    uploadFile();
                }}
                                    ...
                                    db.collection("vouchers")
                                            ...
                                            .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                                                ...
                                                public void onSuccess(DocumentReference documentReference) {
                                                    ...
                                                    Toast.makeText(AdminVoucher.this, "Upload Successful", Toast.LENGTH_SHORT).show();
                                                }
                                            })
                                            .addOnFailureListener(new OnFailureListener() {
                                                @Override
                                                public void onFailure(@NonNull Exception e) {
                                                    Toast.makeText(AdminVoucher.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                                                }
                                            });
                                }
                            });
    ...
    private void openImagesActivity(){
        ...
        Intent intent = new Intent( this, AdminVoucherImages.class);
